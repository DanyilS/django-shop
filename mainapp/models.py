...
class Smartphone(Product):
    diagonal = models.CharField(max_length=255, verbose_name='Диагональ')
    display_type = models.CharField(max_length=255, verbose_name='Тим дисплея')
    ...
    main_cam_mp = models.CharField(max_length=255, verbose_name='Главнеая камера')
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=20, verbose_name='Номрер телефона')
